...
class CreatePseTransactionResponsesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pse_transaction_responses', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('pse_transaction_responses');
    }
}
